...
<html>
    ...
    <body>
        <?php   
            ...
            $_SESSION["WS_X"]=$WS_X;
            $host = "localhost";
            $usuario = "id17192650_estagiometeoro";
            $senha = "E5{V!%s<6_6#]9V8";
            $banco = "id17192650_estacaometeoro";
            ...
            if($contr<3 && $inter != 1 && $grafico !=0){//trata a parte dos gráficos
                if($cont["contagem"]>576){
                    ...
                    echo "<div id=".'"'."chart".'"'." style=".'"'."width: 1300px; height: 500px; padding-left:10px; padding-top: 5px; display: none; ".'"'."></div>";
