...
<html>
	...
	<body class="login">
		...
		<form method="post" action="autentica.php"><!--manda os dados para autentica.php-->
			<br>
			<div class="card">
				<div class="head">
					<p class="cabecalho">Entre a credencial</p>
				</div>
				<label  class="esquerda">Senha</label>
				<input class="input" type="password" name="entrada">
				<br>
				<button type="submit" style="width:30%; margin: 0 auto;">
					<img src="assets/seta.png" alt="enviar" style="width:100%; height:100%;">
				</button>
				<br>
                <a class="link direita" href="login.php">Voltar</a>
			</div>
		</form>
	</body>			
</html>
<?php
	if(array_key_exists("con",$_SESSION)) //se a variavel de controle existe pegue seu valor
		$cont=$_SESSION["con"];
	else
